...
import 'package:chatteree/models/chat.dart';
import 'package:chatteree/models/film.dart';
      ...
      body: SafeArea(
        child: ListView(
          ...
          children: [
            ...
            _films == null ? LinearProgressIndicator() : SizedBox(
                          ...
                          child: Column(
                            ...
                            children: [
                              Container(
                                ...
                                child: CircleAvatar(
                                  backgroundImage:
                                      NetworkImage(_films[index].profilePic),
                                ),
                              ),
                              SizedBox(
                                height: 5,
            ...
            _chats == null ? CircularProgressIndicator.adaptive() :  ListView.separated(
                controller: _scrollController,
                shrinkWrap: true,
                itemBuilder: (context, index) {
                        ...
                        Stack(
                          children: [
                            CircleAvatar(
                              ...
                              backgroundColor: accentColor.withOpacity(.5),
                            ),
                            Positioned(
                              bottom: 3,
                              right: -1,
